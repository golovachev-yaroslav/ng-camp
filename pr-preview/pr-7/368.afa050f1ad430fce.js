  ...
  class LoginFormComponent {
    constructor() {
      ...
      this.loginForm = this.formBuilder.group({
        email: this.formBuilder.control('golovachev@saritasa.com', [_angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.email]),
        password: this.formBuilder.control('qweQWE123!', [_angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.required])
      });
    }
    /**
     * Toggle password.
